...
func TestSpaceUpdater(t *testing.T) {
	...
	now := time.Now()
	updates := []SpaceUpdate{
		{SpaceId: "space1", NewHash: "new1", Updated: now.Add(-2 * time.Hour)},
		{SpaceId: "space1", NewHash: "new2", Updated: now.Add(-1 * time.Hour)},
		{SpaceId: "space1", NewHash: "new3", Updated: now},

		{SpaceId: "space2", NewHash: "new1", Updated: now.Add(-1 * time.Hour)},
		{SpaceId: "space2", NewHash: "new2", Updated: now},

		{SpaceId: "space3", NewHash: "new1", Updated: now},
	}
