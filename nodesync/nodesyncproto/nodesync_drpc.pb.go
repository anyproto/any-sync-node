...
func (c *drpcNodeSyncClient) AdoptArchive(ctx context.Context, in *AdoptArchiveRequest) (*AdoptArchiveResponse, error) {
	out := new(AdoptArchiveResponse)
	err := c.cc.Invoke(ctx, "/anyNodeSync.NodeSync/AdoptArchive", drpcEncoding_File_nodesync_nodesyncproto_protos_nodesync_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCNodeSyncServer interface {
	...
	AdoptArchive(context.Context, *AdoptArchiveRequest) (*AdoptArchiveResponse, error)
}
...
func (s *DRPCNodeSyncUnimplementedServer) AdoptArchive(context.Context, *AdoptArchiveRequest) (*AdoptArchiveResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (DRPCNodeSyncDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 2:
		return "/anyNodeSync.NodeSync/AdoptArchive", drpcEncoding_File_nodesync_nodesyncproto_protos_nodesync_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCNodeSyncServer).
					AdoptArchive(
						ctx,
						in1.(*AdoptArchiveRequest),
					)
			}, DRPCNodeSyncServer.AdoptArchive, true
	default:
...
func (x *drpcNodeSync_PartitionSyncStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcNodeSync_ColdSyncStream) GetStream() drpc.Stream {
	return x.Stream
}
...
type drpcNodeSync_AdoptArchiveStream struct {
	drpc.Stream
}

func (x *drpcNodeSync_AdoptArchiveStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcNodeSync_AdoptArchiveStream) SendAndClose(m *AdoptArchiveResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_nodesync_nodesyncproto_protos_nodesync_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
